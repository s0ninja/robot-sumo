...
void loop() {
  ...
  if (start == true) {
    ...
    digitalWrite(vitesseDroite, 255);
    digitalWrite(vitesseGauche, 255);
    digitalWrite(sensDroite, LOW);
    digitalWrite(sensGauche, HIGH);
    digitalWrite(freinGauche, LOW);
    digitalWrite(freinDroite, LOW);
  } else {
    digitalWrite(led, LOW);
    digitalWrite(vitesseDroite, 0);
    digitalWrite(vitesseGauche, 0);
  }
}
